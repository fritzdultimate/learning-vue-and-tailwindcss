<template>
    <main class="wf-bg-gray-100 wf-h-full wf-flex wf-justify-center wf-items-center">
        <div class="wf-bg-white wf-shadow-lg wf-min-h-1/3 md:wf-w-1/3 wf-rounded-md  wf-p-4 md:wf-m-0 wf-m-4">
            <div class="wf-flex">
                <UserAddIcon class="wf-p-1 wf-bg-green-200 wf-rounded-full wf-text-green-700 wf-text-[5px] wf-h-6 wf-w-6 md:wf-h-8 md:wf-w-8" />
                <div class="wf-text-gray-900 wf-font-bold wf-text-base md:wf-text-lg wf-self-baseline wf-px-3">
                    Register
                </div>
                <router-link to="/auth/login" class="wf-flex wf-ml-auto wf-self-baseline wf-rounded-full wf-p-1 wf-shadow wf-shadow-gray-400">
            ...
            <form @submit.prevent="register">
                ...
                <div class="wf-flex">
                    <button class="wf-flex wf-justify-center wf-bg-yellow-600 wf-outline-transparent wf-border-0 wf-text-white wf-w-full wf-p-2 wf-rounded wf-text-sm wf-font-semibold focus:wf-ring focus:wf-ring-yellow-500/75 disabled:wf-opacity-75" :disabled="processRegistration">
                        <RefreshIcon class="wf-animate-spin wf-h-5 wf-w-5 wf-text-gray-100" v-if="processRegistration"/>
                        <span class="wf-mx-auto" v-if="!processRegistration">Become a member</span>
                    </button>
                </div>
                <div class="wf-border-gray-200/75 wf-border-[.01px] wf-my-4"></div>
                <p class="wf-text-sm wf-text-gray-600 wf-text-center">
                    Already have an account? <a href="#" class="wf-text-yellow-700 wf-font-medium wf-p-1 hover:wf-text-yellow-900">Log in</a>
                </p>
            </form>
        </div>
